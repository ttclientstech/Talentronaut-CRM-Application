...
export default function ProjectsLayout({ children }: { children: React.ReactNode }) {
    ...
    const handleSelect = (item: TreeItem) => {
        ...
        router.push(`/sales/projects?type=${item.type}&id=${item.id}&name=${encodeURIComponent(item.name)}`);
    };
        ...
        <div className="flex h-[calc(100vh-theme(spacing.16))] gap-6">
            ...
            <div className="w-64 shrink-0 bg-white rounded-3xl border border-gray-100 shadow-xl shadow-gray-200/50 flex flex-col overflow-hidden">
                <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                    ...
                    <button onClick={() => router.push('/sales/projects?action=new-project')} className="p-1.5 hover:bg-gray-200 rounded-lg transition-colors text-gray-500" title="New Project">
